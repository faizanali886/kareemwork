  ...
  return (
    <section className="bg-neutral text-neutral-content">
      <div className="max-w-7xl mx-auto px-8 py-16 md:py-32 text-center">
        ...
        Managing personal finances can be overwhelming and complicated. 
        Many individuals struggle to keep track of their spending, savings, 
        investments, and debts, leading to financial stress and uncertainty about their future.
        </p>
